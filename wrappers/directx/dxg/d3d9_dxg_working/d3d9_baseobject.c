...
// HRESULT D3D9BaseObject_GetDeviceEx(D3D9BaseObject* pBaseObject, IDirect3DDevice9** ppDevice)
// {
    // if (pBaseObject->pUnknown)
    // {
        // return IUnknown_QueryInterface(pBaseObject->pUnknown, &IID_IDirect3DDevice9Ex, (void**)ppDevice);
    // }
