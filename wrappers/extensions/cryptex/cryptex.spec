...
@ stdcall -arch=i386 CryptEnumProvidersU(long ptr long ptr wstr ptr)
...
@ stdcall -arch=i386 CryptSetProviderU(wstr long)
...
@ stdcall -arch=i386 CryptSignHashU(ptr long wstr long ptr ptr)
...
@ stdcall -arch=i386 CryptVerifySignatureU(ptr ptr long ptr wstr long)
...
@ stdcall -arch=i386 RegCreateHKCUKeyExU(ptr wstr long wstr long ptr ptr ptr ptr)
@ stdcall -arch=i386 RegCreateKeyExU(ptr wstr long wstr long ptr ptr ptr ptr)
@ stdcall -arch=i386 RegDeleteValueU(ptr wstr)
@ stdcall -arch=i386 RegEnumValueU(ptr long wstr ptr ptr ptr ptr ptr)
@ stdcall -arch=i386 RegOpenHKCUKeyExU(ptr wstr long ptr ptr)
@ stdcall -arch=i386 RegOpenKeyExU(ptr wstr long ptr ptr)
@ stdcall -arch=i386 RegQueryInfoKeyU(ptr wstr ptr ptr ptr ptr ptr ptr ptr ptr ptr ptr)
@ stdcall -arch=i386 RegQueryValueExU(ptr wstr ptr ptr ptr ptr)
