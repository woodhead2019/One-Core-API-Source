 ...
 */
HMODULE WINAPI DECLSPEC_HOTPATCH LoadLibraryExWInternal( LPCWSTR name, HANDLE file, DWORD flags )
{
    UNICODE_STRING str;
    HMODULE module;
...
)
{
    ...
    return LoadLibraryExWInternal( libnameW, hfile, flags );
}
