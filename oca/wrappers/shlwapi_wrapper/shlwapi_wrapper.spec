...
@   stdcall SHAllocShared(ptr long long)
@   stdcall SHLockShared(long long)
@   stdcall SHUnlockShared(ptr)
@  stdcall SHFreeShared(long long)
...
@ stdcall SHGetViewStatePropertyBag(ptr wstr long ptr ptr)
...
#523 stdcall -noname SHPropertyBag_ReadRECTL(ptr wstr
...
@ stdcall -i386 AssocQueryStringByKeyA(long long ptr str ptr ptr)
@ stdcall -i386 AssocQueryStringByKeyW(long long ptr wstr ptr ptr)
@ stdcall -i386 ChrCmpIA(long long)
@ stdcall -i386 ChrCmpIW(long long)
@ stdcall -i386 ColorAdjustLuma(long long long)
@ stdcall -i386 ColorHLSToRGB(long long long)
@ stdcall -i386 ColorRGBToHLS(long ptr ptr ptr)
@ stdcall -i386 GetMenuPosFromID(ptr long)
@ stdcall -i386 HashData(ptr long ptr long)
@ stdcall -i386 IntlStrEqWorkerA(long str str long) StrIsIntlEqualA
@ stdcall -i386 IntlStrEqWorkerW(long wstr wstr long) StrIsIntlEqualW
@ stdcall -i386 IsCharSpaceA(long) ;shlwapibase.IsCharSpaceA
@ stdcall -i386 PathAddBackslashA(str)
@ stdcall -i386 PathAddBackslashW(wstr)
@ stdcall -i386 PathAddExtensionA(str str)
@ stdcall -i386 PathAddExtensionW(wstr wstr)
@ stdcall -i386 PathAppendA(str str)
@ stdcall -i386 PathAppendW(wstr wstr)
@ stdcall -i386 PathBuildRootA(ptr long)
@ stdcall -i386 PathBuildRootW(ptr long)
@ stdcall -i386 PathCanonicalizeA(ptr str)
@ stdcall -i386 PathCanonicalizeW(ptr wstr)
@ stdcall -i386 PathCombineA(ptr str str)
@ stdcall -i386 PathCombineW(ptr wstr wstr)
@ stdcall -i386 PathCommonPrefixA(str str ptr)
@ stdcall -i386 PathCommonPrefixW(wstr wstr ptr)
@ stdcall -i386 PathCompactPathA(long str long)
@ stdcall -i386 PathCompactPathExA(ptr str long long)
@ stdcall -i386 PathCompactPathExW(ptr wstr long long)
@ stdcall -i386 PathCompactPathW(long wstr long)
@ stdcall -i386 PathCreateFromUrlA(str ptr ptr long)
@ stdcall -i386 PathCreateFromUrlW(wstr ptr ptr long)
@ stdcall -i386 PathFileExistsA(str)
@ stdcall -i386 PathFileExistsW(wstr)
@ stdcall -i386 PathFindExtensionA(str)
@ stdcall -i386 PathFindExtensionW(wstr)
@ stdcall -i386 PathFindFileNameA(str)
@ stdcall -i386 PathFindFileNameW(wstr)
@ stdcall -i386 PathFindNextComponentA(str)
@ stdcall -i386 PathFindNextComponentW(wstr)
@ stdcall -i386 PathFindOnPathA(str ptr)
@ stdcall -i386 PathFindOnPathW(wstr ptr)
@ stdcall -i386 PathFindSuffixArrayA(str ptr long)
@ stdcall -i386 PathFindSuffixArrayW(wstr ptr long)
@ stdcall -i386 PathGetArgsA(str)
@ stdcall -i386 PathGetArgsW(wstr)
@ stdcall -i386 PathGetCharTypeA(long)
@ stdcall -i386 PathGetCharTypeW(long)
@ stdcall -i386 PathGetDriveNumberA(str)
@ stdcall -i386 PathGetDriveNumberW(wstr)
@ stdcall -i386 PathIsContentTypeW(wstr wstr)
@ stdcall -i386 PathIsDirectoryA(str)
@ stdcall -i386 PathIsDirectoryEmptyA(str)
@ stdcall -i386 PathIsDirectoryEmptyW(wstr)
@ stdcall -i386 PathIsDirectoryW(wstr)
@ stdcall -i386 PathIsFileSpecA(str)
@ stdcall -i386 PathIsFileSpecW(wstr)
@ stdcall -i386 PathIsLFNFileSpecA(str)
@ stdcall -i386 PathIsLFNFileSpecW(wstr)
@ stdcall -i386 PathIsNetworkPathW(wstr)
@ stdcall -i386 PathIsPrefixA(str str)
@ stdcall -i386 PathIsPrefixW(wstr wstr)
@ stdcall -i386 PathIsRelativeA(str)
@ stdcall -i386 PathIsRelativeW(wstr)
@ stdcall -i386 PathIsRootA(str)
@ stdcall -i386 PathIsRootW(wstr)
@ stdcall -i386 PathIsSameRootA(str str)
@ stdcall -i386 PathIsSameRootW(wstr wstr)
@ stdcall -i386 PathIsSystemFolderA(str long)
@ stdcall -i386 PathIsSystemFolderW(wstr long)
@ stdcall -i386 PathIsUNCA(str)
@ stdcall -i386 PathIsUNCServerA(str)
@ stdcall -i386 PathIsUNCServerShareA(str)
@ stdcall -i386 PathIsUNCServerShareW(wstr)
@ stdcall -i386 PathIsUNCServerW(wstr)
@ stdcall -i386 PathIsUNCW(wstr)
@ stdcall -i386 PathIsURLA(str)
@ stdcall -i386 PathIsURLW(wstr)
@ stdcall -i386 PathMakePrettyA(str)
@ stdcall -i386 PathMakePrettyW(wstr)
@ stdcall -i386 PathMakeSystemFolderA(str)
@ stdcall -i386 PathMakeSystemFolderW(wstr)
@ stdcall -i386 PathMatchSpecA(str str)
@ stdcall -i386 PathMatchSpecW(wstr wstr)
@ stdcall -i386 PathParseIconLocationA(str)
@ stdcall -i386 PathParseIconLocationW(wstr)
@ stdcall -i386 PathQuoteSpacesA(str)
@ stdcall -i386 PathQuoteSpacesW(wstr)
@ stdcall -i386 PathRelativePathToA(ptr str long str long)
@ stdcall -i386 PathRelativePathToW(ptr wstr long wstr long)
@ stdcall -i386 PathRemoveArgsA(str)
@ stdcall -i386 PathRemoveArgsW(wstr)
@ stdcall -i386 PathRemoveBackslashA(str)
@ stdcall -i386 PathRemoveBackslashW(wstr)
@ stdcall -i386 PathRemoveBlanksA(str)
@ stdcall -i386 PathRemoveBlanksW(wstr)
@ stdcall -i386 PathRemoveExtensionA(str)
@ stdcall -i386 PathRemoveExtensionW(wstr)
@ stdcall -i386 PathRemoveFileSpecA(str)
@ stdcall -i386 PathRemoveFileSpecW(wstr)
@ stdcall -i386 PathRenameExtensionA(str str)
@ stdcall -i386 PathRenameExtensionW(wstr wstr)
@ stdcall -i386 PathSearchAndQualifyA(str ptr long)
@ stdcall -i386 PathSearchAndQualifyW(wstr ptr long)
@ stdcall -i386 PathSetDlgItemPathA(long long ptr)
@ stdcall -i386 PathSetDlgItemPathW(long long ptr)
@ stdcall -i386 PathSkipRootA(str)
@ stdcall -i386 PathSkipRootW(wstr)
@ stdcall -i386 PathStripPathA(str)
@ stdcall -i386 PathStripPathW(wstr)
@ stdcall -i386 PathStripToRootA(str)
@ stdcall -i386 PathStripToRootW(wstr)
@ stdcall -i386 PathUnExpandEnvStringsA(str ptr long)
@ stdcall -i386 PathUnExpandEnvStringsW(wstr ptr long)
@ stdcall -i386 PathUndecorateA(str)
@ stdcall -i386 PathUndecorateW(wstr)
@ stdcall -i386 PathUnmakeSystemFolderA(str)
@ stdcall -i386 PathUnmakeSystemFolderW(wstr)
@ stdcall -i386 PathUnquoteSpacesA(str)
@ stdcall -i386 PathUnquoteSpacesW(wstr)
@ stdcall -i386 SHAutoComplete(ptr long)
@ stdcall -i386 SHCopyKeyA(long str long long)
@ stdcall -i386 SHCopyKeyW(long wstr long long)
@ stdcall -i386 SHCreateShellPalette(long)
@ stdcall -i386 SHCreateStreamOnFileA(str long ptr)
@ stdcall -i386 SHCreateStreamOnFileEx(wstr long long long ptr ptr)
@ stdcall -i386 SHCreateStreamOnFileW(wstr long ptr)
@ stdcall -i386 SHCreateStreamWrapper(ptr ptr long ptr)
@ stdcall -i386 SHCreateThreadRef(ptr ptr) shlwapibase.SHCreateThreadRef
@ stdcall -i386 SHDeleteEmptyKeyA(long ptr)
@ stdcall -i386 SHDeleteEmptyKeyW(long ptr)
@ stdcall -i386 SHDeleteKeyA(long str)
@ stdcall -i386 SHDeleteKeyW(long wstr)
@ stdcall -i386 SHDeleteOrphanKeyA(long str)
@ stdcall -i386 SHDeleteOrphanKeyW(long wstr)
@ stdcall -i386 SHDeleteValueA(long str str)
@ stdcall -i386 SHDeleteValueW(long wstr wstr)
@ stdcall -i386 SHEnumKeyExA(long long str ptr)
@ stdcall -i386 SHEnumKeyExW(long long wstr ptr)
@ stdcall -i386 SHEnumValueA(long long str ptr ptr ptr ptr)
@ stdcall -i386 SHEnumValueW(long long wstr ptr ptr ptr ptr)
@ stdcall -i386 SHGetInverseCMAP(ptr long)
@ stdcall -i386 SHGetThreadRef(ptr)
@ stdcall -i386 SHGetValueA(long str str ptr ptr ptr)
@ stdcall -i386 SHGetValueW(long wstr wstr ptr ptr ptr)
@ stdcall -i386 SHIsLowMemoryMachine(long)
@ stdcall -i386 SHOpenRegStream2A(long str str long)
@ stdcall -i386 SHOpenRegStream2W(long wstr wstr long)
@ stdcall -i386 SHOpenRegStreamA(long str str long)
@ stdcall -i386 SHOpenRegStreamW(long wstr wstr long)
@ stdcall -i386 SHQueryInfoKeyA(long ptr ptr ptr ptr)
@ stdcall -i386 SHQueryInfoKeyW(long ptr ptr ptr ptr)
@ stdcall -i386 SHQueryValueExA(long str ptr ptr ptr ptr)
@ stdcall -i386 SHQueryValueExW(long wstr ptr ptr ptr ptr)
@ stdcall -i386 SHRegCloseUSKey(ptr)
@ stdcall -i386 SHRegCreateUSKeyA(str long long ptr long)
@ stdcall -i386 SHRegCreateUSKeyW(wstr long long ptr long)
@ stdcall -i386 SHRegDeleteEmptyUSKeyA(long str long)
@ stdcall -i386 SHRegDeleteEmptyUSKeyW(long wstr long)
@ stdcall -i386 SHRegDeleteUSValueA(long str long)
@ stdcall -i386 SHRegDeleteUSValueW(long wstr long)
@ stdcall -i386 SHRegDuplicateHKey(long)
@ stdcall -i386 SHRegEnumUSKeyA(long long str ptr long)
@ stdcall -i386 SHRegEnumUSKeyW(long long wstr ptr long)
@ stdcall -i386 SHRegEnumUSValueA(long long ptr ptr ptr ptr ptr long)
@ stdcall -i386 SHRegEnumUSValueW(long long ptr ptr ptr ptr ptr long)
@ stdcall -i386 SHRegGetBoolUSValueA(str str long long)
@ stdcall -i386 SHRegGetBoolUSValueW(wstr wstr long long)
@ stdcall -i386 SHRegGetPathA(long str str ptr long)
@ stdcall -i386 SHRegGetPathW(long wstr wstr ptr long)
@ stdcall -i386 SHRegGetUSValueA(str str ptr ptr ptr long ptr long)
@ stdcall -i386 SHRegGetUSValueW(wstr wstr ptr ptr ptr long ptr long)
@ stdcall -i386 SHRegOpenUSKeyA(str long long long long)
@ stdcall -i386 SHRegOpenUSKeyW(wstr long long long long)
@ stdcall -i386 SHRegQueryInfoUSKeyA(long ptr ptr ptr ptr long)
@ stdcall -i386 SHRegQueryInfoUSKeyW(long ptr ptr ptr ptr long)
@ stdcall -i386 SHRegQueryUSValueA(long str ptr ptr ptr long ptr long)
@ stdcall -i386 SHRegQueryUSValueW(long wstr ptr ptr ptr long ptr long)
@ stdcall -i386 SHRegSetPathA(long str str str long)
@ stdcall -i386 SHRegSetPathW(long wstr wstr wstr long)
@ stdcall -i386 SHRegSetUSValueA(str str long ptr long long)
@ stdcall -i386 SHRegSetUSValueW(wstr wstr long ptr long long)
@ stdcall -i386 SHRegWriteUSValueA(long str long ptr long long)
@ stdcall -i386 SHRegWriteUSValueW(long wstr long ptr long long)
@ stdcall -i386 SHRegisterValidateTemplate(wstr long)
@ stdcall -i386 SHReleaseThreadRef()
@ stdcall -i386 SHSetThreadRef(ptr)
@ stdcall -i386 SHSetValueA(long str str long ptr long)
@ stdcall -i386 SHSetValueW(long wstr wstr long ptr long)
@ stdcall -i386 SHSkipJunction(ptr ptr)
@ stdcall -i386 SHStrDupA(str ptr)
@ stdcall -i386 SHStrDupW(wstr ptr)
@ stdcall -i386 StrCSpnA(str str)
@ stdcall -i386 StrCSpnIA(str str)
@ stdcall -i386 StrCSpnIW(wstr wstr)
@ stdcall -i386 StrCSpnW(wstr wstr)
@ stdcall -i386 StrCatBuffA(str str long)
@ stdcall -i386 StrCatBuffW(wstr wstr long)
@ stdcall -i386 StrCatChainW(wstr long long wstr)
@ stdcall -i386 StrCatW(ptr wstr)
@ stdcall -i386 StrChrA(str long)
@ stdcall -i386 StrChrIA(str long)
@ stdcall -i386 StrChrIW(wstr long)
@ stdcall -i386 StrChrNIW(wstr wstr long)
@ stdcall -i386 StrChrNW(wstr long long)
@ stdcall -i386 StrChrW(wstr long)
@ stdcall -i386 StrCmpIW(wstr wstr)
@ stdcall -i386 StrCmpLogicalW(wstr wstr)
@ stdcall -i386 StrCmpNA(str str long)
@ stdcall -i386 StrCmpNIA(str str long)
@ stdcall -i386 StrCmpNIW(wstr wstr long)
@ stdcall -i386 StrCmpNW(wstr wstr long)
@ stdcall -i386 StrCmpW(wstr wstr)
@ stdcall -i386 StrCpyNW(ptr wstr long)
@ stdcall -i386 StrCpyW(ptr wstr)
@ stdcall -i386 StrDupA(str)
@ stdcall -i386 StrDupW(wstr)
@ stdcall -i386 StrFormatByteSize64A(int64 ptr long)
@ stdcall -i386 StrFormatByteSizeA(long ptr long)
@ stdcall -i386 StrFormatByteSizeW(int64 ptr long)
@ stdcall -i386 StrFormatKBSizeA(int64 str long)
@ stdcall -i386 StrFormatKBSizeW(int64 wstr long)
@ stdcall -i386 StrFromTimeIntervalA(ptr long long long)
@ stdcall -i386 StrFromTimeIntervalW(ptr long long long)
@ stdcall -i386 StrIsIntlEqualA(long str str long)
@ stdcall -i386 StrIsIntlEqualW(long wstr wstr long)
@ stdcall -i386 StrNCatA(str str long)
@ stdcall -i386 StrNCatW(wstr wstr long)
@ stdcall -i386 StrPBrkA(str str)
@ stdcall -i386 StrPBrkW(wstr wstr)
@ stdcall -i386 StrRChrA(str str long)
@ stdcall -i386 StrRChrIA(str str long)
@ stdcall -i386 StrRChrIW(wstr wstr long)
@ stdcall -i386 StrRChrW(wstr wstr long)
@ stdcall -i386 StrRStrIA(str str str)
@ stdcall -i386 StrRStrIW(wstr wstr wstr)
@ stdcall -i386 StrRetToBSTR(ptr ptr ptr)
@ stdcall -i386 StrRetToBufA(ptr ptr ptr long)
@ stdcall -i386 StrRetToBufW(ptr ptr ptr long)
@ stdcall -i386 StrRetToStrA(ptr ptr ptr)
@ stdcall -i386 StrRetToStrW(ptr ptr ptr)
@ stdcall -i386 StrSpnA(str str)
@ stdcall -i386 StrSpnW(wstr wstr)
@ stdcall -i386 StrStrA(str str)
@ stdcall -i386 StrStrIA(str str)
@ stdcall -i386 StrStrIW(wstr wstr)
@ stdcall -i386 StrStrNIW(wstr wstr long)
@ stdcall -i386 StrStrNW(wstr wstr long)
@ stdcall -i386 StrStrW(wstr wstr)
@ stdcall -i386 StrToInt64ExA(str long ptr)
@ stdcall -i386 StrToInt64ExW(wstr long ptr)
@ stdcall -i386 StrToIntA(str)
@ stdcall -i386 StrToIntExA(str long ptr)
@ stdcall -i386 StrToIntExW(wstr long ptr)
@ stdcall -i386 StrToIntW(wstr)
@ stdcall -i386 StrTrimA(str str)
@ stdcall -i386 StrTrimW(wstr wstr)
@ stdcall -i386 UrlApplySchemeA(str ptr ptr long)
@ stdcall -i386 UrlApplySchemeW(wstr ptr ptr long)
@ stdcall -i386 UrlCanonicalizeA(str ptr ptr long)
@ stdcall -i386 UrlCanonicalizeW(wstr ptr ptr long)
@ stdcall -i386 UrlCombineA(str str ptr ptr long)
@ stdcall -i386 UrlCombineW(wstr wstr ptr ptr long)
@ stdcall -i386 UrlCompareA(str str long)
@ stdcall -i386 UrlCompareW(wstr wstr long)
@ stdcall -i386 UrlCreateFromPathA(str ptr ptr long)
@ stdcall -i386 UrlCreateFromPathW(wstr ptr ptr long)
@ stdcall -i386 UrlEscapeA(str ptr ptr long)
@ stdcall -i386 UrlEscapeW(wstr ptr ptr long)
@ stdcall -i386 UrlGetLocationA(str)
@ stdcall -i386 UrlGetLocationW(wstr)
@ stdcall -i386 UrlGetPartA(str ptr ptr long long)
@ stdcall -i386 UrlGetPartW(wstr ptr ptr long long)
@ stdcall -i386 UrlHashA(str ptr long)
@ stdcall -i386 UrlHashW(wstr ptr long)
@ stdcall -i386 UrlIsA(str long)
@ stdcall -i386 UrlIsNoHistoryA(str)
@ stdcall -i386 UrlIsNoHistoryW(wstr)
@ stdcall -i386 UrlIsOpaqueA(str)
@ stdcall -i386 UrlIsOpaqueW(wstr)
@ stdcall -i386 UrlIsW(wstr long)
@ stdcall -i386 UrlUnescapeA(str ptr ptr long)
@ stdcall -i386 UrlUnescapeW(wstr ptr ptr long)
@ varargs -i386 wnsprintfA(ptr long str)
@ varargs -i386 wnsprintfW(ptr long wstr)
@ stdcall -i386 wvnsprintfA(ptr long str ptr)
@ stdcall -i386 wvnsprintfW(ptr long wstr ptr)
...
618 stdcall SHWindowsPolicy(ptr) ;Change 618 ordinal from PathIsContentTypeA to SHWindowsPolicy to satisfy Windows 7 wordpad
628 stdcall SHCreateStreamOnModuleResourceW(ptr ptr wstr ptr) ;Change 628 ordinal from PathIsNetworkPathA to SHCreateStreamOnModuleResourceW to satisfy Windows 7 wordpad
