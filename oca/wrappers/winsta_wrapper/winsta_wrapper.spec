...
#missing on Windows XP RTM
@ stdcall RemoteAssistancePrepareSystemRestore(ptr) winstabase.RemoteAssistancePrepareSystemRestore
@ stdcall WinStationAutoReconnect(ptr) winstabase.WinStationAutoReconnect
