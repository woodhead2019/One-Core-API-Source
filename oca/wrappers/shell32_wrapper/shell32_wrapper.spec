...
26  stdcall ILLoadFromStream(ptr ptr) shellbase.ILLoadFromStream
...
121 stdcall SHFlushClipboard() shellbase.SHFlushClipboard
...
148 stdcall SHMapIDListToImageListIndexAsync(ptr ptr ptr long ptr ptr ptr ptr ptr) shellbase.SHMapIDListToImageListIndexAsync
149 stdcall SHFind_InitMenuPopup(long long long long)
151 stdcall SHLoadOLE(long) shellbase.SHLoadOLE
...
161 stdcall SHRunControlPanel(long long) shellbase.SHRunControlPanel
...
166 stdcall CallCPLEntry16(long long long long long long) shellbase.CallCPLEntry16
...
520 stdcall SHAllocShared(ptr long long) shellbase.SHAllocShared
521 stdcall SHLockShared(long long) shellbase.SHLockShared
522 stdcall SHUnlockShared(ptr) shellbase.SHUnlockShared
523 stdcall SHFreeShared(long long) shellbase.SHFreeShared
...
653 stdcall PathProcessCommand(long long long long) shellbase.PathProcessCommand
...
709 stdcall SHGetSetFolderCustomSettingsW(ptr wstr long) shellbase.SHGetSetFolderCustomSettingsW
...
749 stdcall SHGetShellStyleHInstance() shellbase.SHGetShellStyleHInstance
...
@ stdcall Activate_RunDLL(long ptr ptr ptr) shellbase.Activate_RunDLL
@ stdcall AppCompat_RunDLLW(ptr ptr wstr long)
@ stdcall CheckEscapesA(str long) shellbase.CheckEscapesA
@ stdcall CheckEscapesW(wstr long)
@ stdcall Control_FillCache_RunDLL(long long long long) shellbase.Control_FillCache_RunDLL
@ stdcall Control_FillCache_RunDLLA(long long long long) shellbase.Control_FillCache_RunDLLA
@ stdcall Control_FillCache_RunDLLW(long long long long) shellbase.Control_FillCache_RunDLLW
...
@ stdcall ExtractIconResInfoA(ptr str long ptr ptr) shellbase.ExtractIconResInfoA
@ stdcall ExtractIconResInfoW(ptr wstr long ptr ptr) shellbase.ExtractIconResInfoW
@ stdcall ExtractIconW(long wstr long)
@ stdcall ExtractVersionResource16W(wstr ptr) shellbase.ExtractVersionResource16W
@ stdcall FindExecutableA(str str ptr)
@ stdcall FindExecutableW(wstr wstr ptr)
@ stdcall FindExeDlgProc(ptr long ptr ptr) shellbase.FindExeDlgProc
...
@ stdcall SheChangeDirExA(str) shellbase.SheChangeDirExA
@ stdcall SheChangeDirExW(wstr)
@ stdcall SheChangeDirW(wstr) shellbase.SheChangeDirW
@ stdcall SheConvertPathW(wstr wstr long) shellbase.SheConvertPathW
@ stdcall SheFullPathA(str long str) shellbase.SheFullPathA
@ stdcall SheFullPathW(wstr long wstr) shellbase.SheFullPathW
@ stdcall SheGetCurDrive() shellbase.SheGetCurDrive
@ stdcall SheGetDirA(long long)
@ stdcall SheGetDirExW(wstr ptr wstr) shellbase.SheGetDirExW
@ stdcall SheGetDirW(long long) shellbase.SheGetDirW
@ stdcall SheGetPathOffsetW(wstr) shellbase.SheGetPathOffsetW
@ stdcall SheRemoveQuotesA(str) shellbase.SheRemoveQuotesA
@ stdcall SheRemoveQuotesW(wstr) shellbase.SheRemoveQuotesW
@ stdcall SheSetCurDrive(long)
@ stdcall SheShortenPathA(str long) shellbase.SheShortenPathA
@ stdcall SheShortenPathW(wstr long) shellbase.SheShortenPathW
...
@ stdcall StrCpyNA (ptr str long) shellbase.StrCpyNA
@ stdcall StrCpyNW(wstr wstr long) shellbase.StrCpyNW
...
@ stdcall StrNCpyA (ptr str long) shellbase.StrNCpyA
@ stdcall StrNCpyW(wstr wstr long) shellbase.StrNCpyW
...
#Functions exported by Longhorn shellbase.dll
...
# Functions exported by the WinVista shellbase.dll
