...
@ stdcall CM_Create_Range_List(long long) setupapi.CM_Create_Range_List
...
@ stdcall CM_Delete_Range(long long long long) setupapi.CM_Delete_Range
@ stdcall CM_Detect_Resource_Conflict(ptr long ptr long ptr long) setupapi.CM_Detect_Resource_Conflict
@ stdcall CM_Detect_Resource_Conflict_Ex(ptr long ptr long ptr long ptr) setupapi.CM_Detect_Resource_Conflict_Ex
...
@ stdcall CM_Dup_Range_List(ptr ptr long) setupapi.CM_Dup_Range_List
...
@ stdcall CM_Get_Resource_Conflict_Count(ptr ptr) setupapi.CM_Get_Resource_Conflict_Count
@ stdcall CM_Get_Resource_Conflict_DetailsA(ptr long ptr) setupapi.CM_Get_Resource_Conflict_DetailsA
@ stdcall CM_Get_Resource_Conflict_DetailsW(ptr long ptr) setupapi.CM_Get_Resource_Conflict_DetailsW
...
@ stdcall CM_Intersect_Range_List(ptr ptr ptr long) setupapi.CM_Intersect_Range_List
@ stdcall CM_Invert_Range_List(ptr ptr long long) setupapi.CM_Invert_Range_List
...
@ stdcall CM_Merge_Range_List(ptr ptr ptr long) setupapi.CM_Merge_Range_List
...
@ stdcall CM_Next_Range(ptr ptr ptr long) setupapi.CM_Next_Range
...
@ stdcall CM_Query_Resource_Conflict_List(ptr ptr long ptr long long ptr) setupapi.CM_Query_Resource_Conflict_List
...
@ stdcall CM_Test_Range_Available(long long ptr long) setupapi.CM_Test_Range_Available
