...
HINSTANCE WINAPI ShellExecuteWNative(HWND hwnd, LPCWSTR lpVerb, LPCWSTR lpFile,
                               LPCWSTR lpParameters, LPCWSTR lpDirectory, INT nShowCmd);
							   
BOOL WINAPI Shell_NotifyIconWNative(DWORD dwMessage, PNOTIFYICONDATAW lpData);
BOOL WINAPI Shell_NotifyIconANative(DWORD dwMessage, PNOTIFYICONDATAA pnid);

HRESULT WINAPI DllGetClassObjectNative(REFCLSID rclsid, REFIID iid, LPVOID *ppv);
